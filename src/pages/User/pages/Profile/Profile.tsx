      ...
      <div className='mt-8 flex flex-col-reverse md:flex-row md:items-start'>
        ...
        <div className='flex justify-center md:w-72 md:border-l md:border-l-gray-200'>
          <div className='flex flex-col items-center'>
            ...
            <button className='flex h-10 items-center justify-end rounded-sm border-1 border-gray-300 bg-white px-6 text-sm text-gray-600 hover:shadow-sm hover:bg-gray-100 cursor-pointer'>
              Chọn ảnh
            </button>
